package com.leaf.id.generator.gen.snowflake;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.common.collect.Maps;
import com.leaf.id.generator.common.PropertyFactory;
import com.leaf.id.generator.common.Utils;
import com.leaf.id.generator.exception.CheckLastTimeException;
...
public class SnowflakeZookeeperHolder {
    ...
    private String zkNode = null;//保存自身的key  ip:port-000000001
    ...
    public boolean init() {
        ...
        this.ip  = Utils.getIp();
        this.listenAddress = ip + ":" + port;
        this.connectionString = listenAddress;
        try {
            ...
            if (stat == null) {
                ...
                zkNode = createNode(curator);
                //worker id 默认是0
                updateLocalWorkerID(workerID);
                //定时上报本机时间给forever节点
                ScheduledUploadData(curator, zkNode);
                return true;
            } else {
                ...
                if (workerid != null) {
                    ...
                    zkNode = PATH_FOREVER + "/" + realNode.get(listenAddress);
                    workerID = workerid;//启动worder时使用会使用
                    if (!checkInitTimeStamp(curator, zkNode)) {
    ...
    private void doService(CuratorFramework curator) {
        ScheduledUploadData(curator, zkNode);// /snowflake_forever/ip:port-000000001
    }
        ...
        Executors.newSingleThreadScheduledExecutor(new ThreadFactory() {
            ...
            public void run() {
                ...
                try {
                    ...
                    curator.setData().forPath(zk_AddressNode, buildData().getBytes());
                    lastUpdateTime = System.currentTimeMillis();
                } catch (Exception e) {
                    LOGGER.info("update init data error path is {} error is {}", zk_AddressNode, e);
                }
            }
