package com.leaf.id.generator.gen.segment;
...
import com.leaf.id.generator.dao.model.Segment;
import com.leaf.id.generator.dao.model.SegmentBuffer;
...
public class SegmentIDGenerator implements IDGenerator {
    ...
    public static final String BEAN_NAME="segment";
    ...
    public void updateSegmentFromDb(String key, Segment segment) {
        ...
        LeafAlloc leafAlloc;
        if (!buffer.isInitOk()) {
            idAllocMapper.updateMaxId(key);
            leafAlloc = idAllocMapper.getLeafAlloc(key);
            ...
            idAllocMapper.updateMaxIdByCustomStep(temp.getKey());
            leafAlloc = idAllocMapper.getLeafAlloc(temp.getKey());
